package com.zhouliang.utils.dao;
...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property UserGender = new Property(2, String.class, "userGender", false, "USER_GENDER");
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // userGender
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setUserGender(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
